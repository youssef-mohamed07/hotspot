      ...
      <div className="grid items-start gap-6 md:grid-cols-2">
        <div
          ...
          style={{
            ...
            transform: visible ? "translate(0, 0)" : `translate(${cardEnterX}px, 20px)`,
            opacity: visible ? 1 : 0,
          }}
        >
          <div className="spotlight-card glass-card group rounded-3xl p-7 text-start hover:border-white/20 md:p-8">
            ...
            <p className="mt-3 text-sm leading-relaxed text-zinc-600 md:text-base">{step.blurb}</p>
          </div>
        </div>
        ...
        <div
          ...
          style={{
            ...
            transform: visible ? "translate(0, 0)" : `translate(${numeralEnterX}px, 0)`,
            opacity: visible ? 1 : 0,
          }}
        >
          <span
