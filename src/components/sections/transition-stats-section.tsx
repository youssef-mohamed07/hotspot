  ...
  return (
    <section className="relative overflow-hidden bg-white py-20 sm:py-28">
      <div
        ...
        style={{
          background:
            "radial-gradient(60% 60% at 50% 50%, rgba(42,118,166,0.12), transparent 75%)",
        }}
        aria-hidden
      />
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div
          dir={isRtl ? "rtl" : "ltr"}
          className="grid gap-px overflow-hidden rounded-3xl border border-zinc-200 bg-zinc-200 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 shadow-sm"
        >
