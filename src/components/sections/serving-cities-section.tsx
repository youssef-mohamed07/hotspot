  ...
  return (
    <section className="relative flex min-h-[100dvh] flex-col items-center justify-center overflow-hidden py-24">
      <div
        ...
        style={{
          background: "radial-gradient(50% 50% at 50% 50%, rgba(42,118,166,0.2), transparent 70%)",
        }}
        aria-hidden
      />
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <Reveal className="mb-16 max-w-3xl text-start">
          <p className="text-xs uppercase tracking-[0.3em] text-accent">{dict.cities.eyebrow}</p>
          <h2 className="display-headline mt-4 text-4xl text-zinc-900 sm:text-5xl md:text-6xl">
            {dict.cities.headline1}
            <br />
            <span className="text-gradient-accent">{dict.cities.headlineAccent}</span>
          </h2>
